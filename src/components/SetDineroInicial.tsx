    ...
    return (
        <div className='flex gap-4 items-end'>
            <div className='flex flex-col  items-start'>
                <label className='text-gray-700 dark:text-gray-300'>Dinero inicial</label>
                <input
                    type="number"
                    value={cantidad}
            ...
            <button onClick={() => {
                ...
                setCantidad(0)
            }} className={cn('bg-violet-600 text-white h-fit rounded px-3 py-2 shadow-xl cursor-pointer hover:bg-violet-700 dark:bg-pink-500 dark:hover:bg-pink-600')}>
                Calcular
            </button>
        </div>
